...
class GridSystem {
    constructor() {
        ...
        this.playersArr = [
            this.p1 = new Player({x: 5, y: 4, lable: 13, id: this.extraArr[0], area: "area1", color: "grey", startingSteps: 500}),

            this.p2 = new Player({x: 4, y: 4, lable: 3, id: this.extraArr[1], area: "area1", color: "springgreen"}),
            this.p3 = new Player({x: 6, y: 4, lable: 4, id: this.extraArr[2], area: "area1", color: "orange"}),
            this.p4 = new Player({x: 7, y: 4, lable: 5, id: this.extraArr[3], area: "area1", color: "lightblue"}),
            this.p5 = new Player({x: 8, y: 4, lable: 6, id: this.extraArr[4], area: "area1", color: "moccasin"}),
            this.p6 = new Player({x: 9, y: 4, lable: 7, id: this.extraArr[5], area: "area1", color: "deepskyblue"}),
            this.p7 = new Player({x: 19, y: 4, lable: 8, id: this.extraArr[6], area: "area1", color: "white"}),
            this.p8 = new Player({x: 20, y: 4, lable: 9, id: this.extraArr[7], area: "area1", color: "hotpink"}),
            this.p9 = new Player({x: 21, y: 4, lable: 10, id: this.extraArr[8], area: "area1", color: "teal"}),
            this.p10 = new Player({x: 27, y: 4, lable: 11, id: this.extraArr[9], area: "area1", color: "yellow"}),
            this.p11 = new Player({x: 28, y: 4, lable: 12, id: this.extraArr[10], area: "area1", color: "turquoise"})
        ];
